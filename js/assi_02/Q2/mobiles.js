var mobiles = {
    iphone: {
        iphone7: {
            ...
            brand: "iphone",
            battery: 5000,
            operatingSystem: "Android 13", // Note: iPhones typically run iOS
        ...
        iphone8: {
            ...
            battery: 8000,
            operatingSystem: "iphone 8", // Note: iPhones typically run iOS
            specialFeatures: ["S Pen support", "Ultrasonic fingerprint sensor"],
        },
        iphone8plus: {
        ...
        iphoneX: {
            ...
            battery: 6000,
            operatingSystem: "iphone X", // Note: iPhones typically run iOS
            specialFeatures: ["S Pen support", "Ultrasonic fingerprint sensor"],
        },
        iphone11: {
            ...
            brand: "iphone",
            battery: 10000,
            operatingSystem: "iphone 11", // Note: iPhones typically run iOS
            specialFeatures: ["S Pen support", "Ultrasonic fingerprint sensor"],
        },
    },
    xiomi: {
    ...
    realme: {
        ...
        realmiC53: {
            ...
            model: " hypothetical model ", // Replace with specific model name
            display: {
                size: "7.1 inches", // Corrected: "7. 1inches" to "7.1 inches"
    ...
    samsung: {
        samsung_Galaxy_S24: {
            brand: "Samsung",
            modelName: "Galaxy S24 Ultra", // Replace with specific model
            display: {
                size: 6.8, // Inches
        ...
        samsung_Galaxy_S51: {
            brand: "Samsung",
            modelName: "Galaxy S51 Pro", // Replace with specific model
            display: {
                size: 7.2, // Inches
                resolution: "3088x1440",
                panelType: "AMOLED",
        ...
        samsung_Galaxy_Prime: {
            brand: "Samsung",
            modelName: "Galaxy Prime Ultra", // Replace with specific model
            display: {
                size: 7.4, // Inches
                resolution: "3088x1440",
                panelType: "AMOLED",
        ...
        samsung_Galaxy_S46: {
            brand: "Samsung",
            modelName: "Galaxy S46 Ultra", // Replace with specific model
            display: {
                size: 5.11, // Inches
                resolution: "3088x1440",
                panelType: "AMOLED",
        ...
        samsung_Galaxy_S77: {
            brand: "Samsung",
            modelName: "Galaxy S77 Ultra", // Replace with specific model
            display: {
                size: 8.5, // Inches
                resolution: "3088x1440",
                panelType: "AMOLED",

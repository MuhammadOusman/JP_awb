  ...
  return (
    <>
      <Box className={styles.baseForm}>
        <Typography
          variant="h4"
          sx={{ fontWeight: "bold", mb: 2, color: "var(--neon-green)", fontFamily: "var(--font-family-primary)" }}
        >
          Teacher Allocation
        </Typography>
        ...
        <FormControl fullWidth sx={{ mb: 3 }} variant="outlined">
          <InputLabel
            ...
            sx={{
              "&.Mui-focused": { color: "var(--neon-green)" },
          ...
          >
            <MenuItem value="" disabled sx={{ fontFamily: "var(--font-family-primary)", color: "var(--text-secondary)" }}>
              Select Teacher
            </MenuItem>
        ...
        <Box sx={{ mt: 2 }}>
          <FormControl component="fieldset" variant="standard">
            <FormLabel
              component="legend"
              sx={{ color: "var(--neon-green) !important", fontWeight: "bold", fontFamily: "var(--font-family-primary)" }}
            >
              Classes:
            </FormLabel>
